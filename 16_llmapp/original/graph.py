...
# システムプロンプト
SYSTEM_PROMPT = [
  SystemMessage("あなたは猫です。にゃーと答えます。"),
]
...
# ===== グラフの構築 =====
def build_graph(model_name: str, memory):
    """
...
# ===== 応答を返す関数 =====
def get_bot_response(user_message: str, memory, thread_id):
    """
